...
var headerCtrl = function($scope, $timeout, $filter, signService, $rootScope, $location, employerService, callSocket) {
...
headerCtrl.$inject = ['$scope', '$timeout', '$filter', 'signService', '$rootScope' , '$location', 'employerService', 'callSocket'];
